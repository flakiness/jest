...
```bash
git clone https://github.com/flakiness/jest.git fk-jest
cd fk-jest
pnpm install
```
...
3. [Create a GitHub Release](https://github.com/flakiness/jest/releases/new) for the new tag and publish it.
